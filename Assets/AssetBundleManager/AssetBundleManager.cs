	...
	public class AssetBundleManager : MonoBehaviour
	{
		...
		public static void SetDevelopmentAssetBundleServer ()
		{
			...
			if (url == null || url.Length == 0) {
				...
				AssetBundleManager.SetSourceAssetBundleURL ("http://10.0.1.6:7888/");
			} else {
		...
		static protected string RemapVariantName (string assetBundleName)
		{
			try {
				...
				Debug.Log ("RemapVariantName : assetBundleName : " + assetBundleName);
				// Get base bundle name
				if(assetBundleName.Equals ("")){
					return "";
				}
				...
				Debug.LogError ("RemapVariantName : " + exception);
			}
			return "";
		}
		...
		void ProcessFinishedOperation (AssetBundleLoadOperation operation)
		{
			...
			if (download.error == null) {
				Log (LogType.Info, "Loaded download.assetBundleName : " + download.assetBundleName);
//				string []assetNames = download.assetBundle.m_AssetBundle.GetAllAssetNames ();
//				foreach (string name in assetNames) {
//					Log (LogType.Info , "BundleName : " + download.assetBundleName + "| asset Name :"+name );
//				}
		...
		static public AssetBundleLoadAssetOperation LoadAssetAsync (string assetBundleName, string assetName, System.Type type)
		{
    ...
    #endif
            {
				...
				Debug.Log ("AssetBundleLoadAssetOperationFull |assetBundleName: " + assetBundleName + " |assetName: " + assetName + " |type: " + type);
